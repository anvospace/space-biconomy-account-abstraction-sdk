...
describe('SimpleAccountAPI', () => {
    ...
    before('init', async () => {
        ...
        src_1.DeterministicDeployer.init(hardhat_1.ethers.provider);
        const factoryAddress = await src_1.DeterministicDeployer.deploy(new contracts_1.SimpleAccountFactory__factory(), 0, [entryPoint.address]);
